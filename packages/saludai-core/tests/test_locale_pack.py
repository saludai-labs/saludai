...
class TestARLocalePack:
    ...
    def test_tool_system_enum(self) -> None:
        assert AR_LOCALE_PACK.tool_system_enum == ("snomed_ct", "cie_10", "loinc", "atc")
